...
[View the tutorial with images](http://edwinv710.github.io/blog/2015/12/15/build_an_aws_endpoint.html)
...
First, we need to sign-up for a Twilio account. Go to (http://www.twilio.com) and sign-up for a trial account. After you have finished the sign up process, please make sure that you obtain a new phone number for your trial account.  Also, please be sure to find and make note of your account's API credentials. 
...
```
   ...
   $ npm init
```
After our project has been initialize, we will need to install the necessary dependencies. 
...
#### Set-up your lambda function on AWS
...
{% include post_screenshot.html link='blog/twilio-lambda-article/001LambdaBlueprint.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/002LambdaCreateCode.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/003LambdaConfig.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/004Gateway.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/005Gateway.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/006Gateway.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/007Gateway.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/008Lambda.png' %}
...
{% include post_screenshot.html link='blog/twilio-lambda-article/010Lambda.png' %}
